...
class ExponentialBackoff {
    ...
    get factor() {
        var _a;
        return (_a = this.props.factor) !== null && _a !== undefined ? _a : 1000;
    }
    get base() {
        var _a;
        return (_a = this.props.base) !== null && _a !== undefined ? _a : 2;
    }
    get maxAttempts() {
        var _a;
        return (_a = this.props.maxAttempts) !== null && _a !== undefined ? _a : Number.POSITIVE_INFINITY;
    }
    get timeout() {
...
class PaginatorHttp {
    ...
    next() {
        return __awaiter(this, undefined, undefined, function* () {
            ...
            this.nextPath = nextUrl === null || nextUrl === undefined ? undefined : nextUrl.pathname;
            this.nextParams = nextUrl === null || nextUrl === undefined ? undefined : nextUrl.search.replace(/^\?/, "");
...
class HttpActionDispatcher {
    ...
    dispatch(action) {
        ...
        if (result instanceof Promise) {
            return result.then((result) => { var _a; return (_a = this.hook) === null || _a === undefined ? undefined : _a.afterDispatch(action, result); });
        }
        else {
...
class WebSocketConnectorImpl {
    ...
    kill() {
        var _a;
        this.killed = true;
        (_a = this.ws) === null || _a === undefined ? undefined : _a.close();
        this.backoff.clear();
        ...
        return __awaiter(this, undefined, undefined, function* () {
            ...
            while (!this.killed) {
                ...
                try {
                    ...
                    (_e = this.logger) === null || _e === undefined ? undefined : _e.log("error", "WebSocket error:", error);
                }
                this.ws = undefined;
            }
            for (const { reject } of this.queue) {
...
function toAsyncIterable(ws) {
    return __asyncGenerator(this, arguments, function* toAsyncIterable_1() {
        var _a, e_1, _b, _c;
        const handleClose = (e) => __awaiter(this, undefined, undefined, function* () {
        ...
        const handleError = (e) => __awaiter(this, undefined, undefined, function* () {
            /* istanbul ignore next */
            if (!events.return) {
                throw new MastoUnexpectedError("events.return is undefined");
            }
...
class WebSocketSubscription {
    ...
    test(event) {
        ...
        const params = (_a = this.params) !== null && _a !== undefined ? _a : {};
...
class WebSocketSubscriptionCounterImpl {
    ...
    count(stream, params) {
        ...
        return (_a = this.counts.get(key)) !== null && _a !== undefined ? _a : 0;
    }
...
class WebSocketActionDispatcher {
    ...
    dispatch(action) {
        ...
        const data = (_a = action.data) !== null && _a !== undefined ? _a : {};
...
class HttpActionDispatcherHookMastodon {
    ...
    afterDispatch(action, result) {
        ...
        if (action.type === "create" && action.path === "/api/v2/media") {
            const media = result;
            if (isRecord(action.data) && ((_a = action.data) === null || _a === undefined ? undefined : _a.skipPolling) === true) {
                return media;
            }
...
class HttpConfigImpl {
    ...
    mergeHeadersWithDefaults(override = {}) {
        ...
        const headersInit = mergeHeadersInit([
            (_b = (_a = this.props.requestInit) === null || _a === undefined ? undefined : _a.headers) !== null && _b !== undefined ? _b : {},
            override,
        ]);
    ...
    mergeAbortSignalWithDefaults(signal) {
        ...
        if ((_a = this.props.requestInit) === null || _a === undefined ? undefined : _a.signal) {
...
const getEncoding = (headers) => {
    var _a;
    const contentType = (_a = headers.get("Content-Type")) === null || _a === undefined ? undefined : _a.replace(/\s*;.*$/, "");
    ...
    request(params) {
        return __awaiter(this, undefined, undefined, function* () {
            ...
            try {
                ...
                (_e = this.logger) === null || _e === undefined ? undefined : _e.log("debug", `HTTP failed`, error);
...
const createLogger = (type) => {
    const level = LogLevel.from(type !== null && type !== undefined ? type : "warn");
